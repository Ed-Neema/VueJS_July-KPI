<template>
    <jet-action-section>
        ...
        <template #content>
            <div class="max-w-xl text-primary-secondarygrey font-normal text-body">
                    ...
                    <div class="ml-3">
                        ...
                        <div>
                            <div class="text-xs text-gray-500">
                                ...
                                <span class="text-green-500 font-semibold" v-if="session.is_current_device">This
                                    device</span>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    ...
                    <div class="mt-4">
                        <jet-input type="password" class="mt-1 block w-3/4" placeholder="Password" ref="password"
                ...
                <template #footer>
                    ...
                    <jet-button class="ml-2 bg-primary-logoutofothersessions text-body font-normal text-white"
                        @click="logoutOtherBrowserSessions" :class="{ 'opacity-25': form.processing }"
