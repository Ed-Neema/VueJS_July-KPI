<template>
    <jet-action-section>
        ...
        <template #content>
            <h3 class="text-primary-secondarygrey font-bold text-body" v-if="twoFactorEnabled">
                You have enabled two factor authentication.
            </h3>

            <h3 class="text-primary-secondarygrey font-bold text-body" v-else>
                You have not enabled two factor authentication.
            </h3>

            <div class="mt-3 max-w-xl text-primary-secondarygrey font-normal text-body">
                <p>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-gray-600">
                        <p class="text-primary-secondarygrey font-normal text-body">
